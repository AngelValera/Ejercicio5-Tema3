...
module.exports = function(grunt) {
	...
	shell: {
	    ...
	    puts: {
		command: 'curl -X PUT http://localhost:5000/porra/Betis/Sevilla/Copa/2015; curl -X PUT http://localhost:5000/porra/Madri/Barcelona/Champion/2003,  curl -X PUT http://localhost:5000/apuesta/Angel/Copa/2015/Betis/3/Sevilla/0'
	    }
	}
    });
